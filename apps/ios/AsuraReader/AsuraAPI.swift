...
actor AsuraAPI: AsuraSource {
    ...
    func request(_ path: String, method: String = "GET", body: Data? = nil, token: String? = nil) async throws -> Data {
        guard path.hasPrefix("/"), let url = URL(string: "https://api.asurascans.com/api" + path) else { throw ReaderError.message("Invalid Asura request") }
        var request = URLRequest(url: url)
        request.httpMethod = method; request.httpBody = body
        request.setValue("https://asurascans.com/", forHTTPHeaderField: "Referer")
