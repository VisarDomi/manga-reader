...
let package = Package(name: "ReaderCoreTests", platforms: [.macOS(.v13)], dependencies: [
    ...
    .executableTarget(name: "ReaderCoreTests", dependencies: ["SwiftSoup"], path: ".",
        ...
        sources: ["AsuraReader/Models.swift", "AsuraReader/ReaderProvider.swift", "AsuraReader/AsuraAPI.swift", "AsuraReader/ScytheAPI.swift", "AsuraReader/PCBackup.swift", "AsuraReader/ReaderStore.swift", "Tests/CoreTests.swift"])
])
