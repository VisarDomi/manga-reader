export type LogEvent =
    ...
    | { event: 'reader-scroll-session'; phase: 'start' | 'stable' | 'idle-granted' | 'idle-cancelled' | 'rebase-request' | 'rebase-skipped'; mangaId: string | null; scrollTop: number; stableFrames?: number; quietMs?: number; reason?: string; edge?: 'top' | 'bottom' }
