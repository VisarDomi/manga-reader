export type LogEvent =
    ...
    | { event: 'reader-window-anchor-adjust-queued'; source: 'initial' | 'scroll' | 'visible' | 'retry'; mangaId: string; chapterId: string; anchorChapterId: string; delta: number; pendingDelta: number; frameEpoch: number }
