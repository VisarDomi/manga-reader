export type LogEvent =
    ...
    | { event: 'search-page-flow'; action: 'skip' | 'start' | 'done' | 'error'; query: string; requestedPage: number; currentPage: number; resultCount: number; hasMore: boolean; machineActive: boolean; isRestoring: boolean; added?: number; error?: string }
